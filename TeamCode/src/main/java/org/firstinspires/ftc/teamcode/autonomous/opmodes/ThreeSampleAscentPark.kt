...
@Autonomous(name = "Three Sample Ascent Park")
class ThreeSampleAscentPark: NextFTCOpMode(Arm, Claw, Intake, IntakeExtension, IntakePivot, IntakeSensor, Lift, Lights) {
...
//        rb.power = (driveP + strafe - turn) / denominator
    ...
    override fun onStartButtonPressed() {
        SampleRoutines.threeSampleAscentPark()
    }
}