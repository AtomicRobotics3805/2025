...
@Autonomous(name = "BiggerSpecimenAuton", group = "specimens")
class BiggerSpecimenAuton: NextFTCOpMode(Arm, Claw, Intake, IntakeExtension, IntakePivot, IntakeSensor, Lift, Lights) {
    ...
    override fun onStartButtonPressed() {
        SpecimenRoutines.biggerSpecimenAuton()
    }
}